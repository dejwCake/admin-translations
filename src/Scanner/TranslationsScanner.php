 ...
 * We have chosen not to use the whole package as long as it will auto-register commands
 * (once Laravel's 5.5-provider auto-discovery is out) that we would like not to
 * be available. If you find a better way, we would appreciate the advice:)
 */

final class TranslationsScanner
{
    /**
